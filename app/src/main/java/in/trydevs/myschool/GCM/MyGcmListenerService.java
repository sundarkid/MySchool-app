...
import in.trydevs.myschool.Activities.MainActivity;
...
public class MyGcmListenerService extends GcmListenerService {
    ...
    public void onMessageReceived(String from, Bundle data) {
        ...
        List<People> peoples = Decoder.decodePeople(message);
        List<Post> posts = Decoder.decodePost(message);
        List<Image> images = Decoder.decodeImage(message);

        if (posts.size() > 0 || peoples.size() > 0 || images.size() > 0) {
            if (posts.size() > 0) {
    ...
    private void sendNotification(String message) {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this)
                ...
                .setContentTitle(getString(R.string.myschool))
