...
import in.trydevs.myschool.Database.DBMySchool;
...
public class MyApplication extends Application {
    ...
    private static DBMySchool dataBase;
...
//    private JobScheduler mJobScheduler;
    ...
    public synchronized static DBMySchool getWritableDatabase() {
        if (dataBase == null) {
            Log.d("database", "creating object");
            dataBase = new DBMySchool(getAppContext());
        }
