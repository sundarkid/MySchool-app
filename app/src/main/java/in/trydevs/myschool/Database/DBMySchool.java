...
public class DBMySchool {
    ...
    public void insertImageData(List<Image> images){
        ...
        for (int i = 0; i < images.size() ; i++){
            ...
            statement.clearBindings();
            statement.bindString(1, Integer.toString(current.getId()));
            statement.bindString(2, current.getLink());
            statement.bindString(3,current.getTitle());
        ...
        if (cursor != null && cursor.moveToFirst()){
            ...
            do{
               Image image = new Image();
                image.setId(cursor.getInt(index_sno));
                image.setLink(cursor.getString(index_image));
