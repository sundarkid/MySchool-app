...
import in.trydevs.myschool.Adapters.MyFragmentAdapter;
import in.trydevs.myschool.GCM.QuickstartPreferences;
import in.trydevs.myschool.GCM.RegistrationIntentService;
import in.trydevs.myschool.R;
import in.trydevs.myschool.tabs.SlidingTabLayout;
